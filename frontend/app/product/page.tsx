  ...
  return (
    <div className="min-h-screen bg-background text-white">
      ...
      <main className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        ...
        <div className="mb-10 flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select
              ...
              className="rounded-full border border-white/10 bg-surface py-2.5 pl-4 pr-8 text-xs font-bold uppercase tracking-widest text-zinc-400 focus:border-white/25 focus:outline-none"
            >
        ...
        {/* CTA */}
        <div className="mt-16 overflow-hidden rounded-3xl border border-white/[0.08] bg-surface">
          <div className="flex flex-col items-center gap-4 px-8 py-12 text-center sm:px-12">
            ...
            <a
              href={whatsappLink || "#"}
              className="mt-2 inline-flex items-center gap-2.5 rounded-full bg-white px-7 py-3.5 text-xs font-black uppercase tracking-widest text-background transition hover:bg-zinc-200"
            >
