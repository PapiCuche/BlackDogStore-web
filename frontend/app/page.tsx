  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            {CATALOG_SECTIONS.map((section) => (
              <Link
                ...
                className="group flex flex-col items-center gap-3 rounded-2xl border border-white/[0.08] bg-surface p-5 text-center transition hover:border-white/20 hover:bg-surface"
              >
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {REPAIR_SERVICES.map((s) => (
              <a
                key={s.title}
                href="/services"
                className="group relative overflow-hidden rounded-2xl border border-white/[0.08] bg-surface p-6 transition hover:border-white/20 hover:bg-surface"
              >
                {/* Badge */}
                {s.badge && (
        ...
        {/* Guarantee strip */}
        <section className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-surface">
          ...
          <div className="relative grid gap-8 px-8 py-12 sm:px-12 sm:py-16 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  href={whatsappLink || "#"}
                  className="inline-flex items-center gap-2.5 rounded-full bg-white px-7 py-3.5 text-sm font-black uppercase tracking-widest text-background transition hover:bg-zinc-200"
                >
        ...
        <section className="py-20">
          ...
          {error ? (
            ...
            <div className="mt-8 flex flex-col items-center gap-6 rounded-3xl border border-dashed border-white/10 p-16 text-center">
              ...
              <a
                href={whatsappLink || "#"}
                className="rounded-full bg-white px-6 py-3 text-xs font-black uppercase tracking-widest text-background transition hover:bg-zinc-200"
              >
                Consultar stock
              </a>
            </div>
